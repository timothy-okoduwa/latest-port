...
const Downtown = () => {
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('gmail', 'template_915la2v', e.target, 'opXca3zh-s4K59S01')
      .then((result) => {
...
<FormHolder>
  <TopForm>
    ...
    <InputHolder>
      <Label>Email :</Label>
      <Input type="email" placeholder='put in your email' name='email' />
    </InputHolder>
  </TopForm> 
  <MessageHolder>
    {" "}
